...
public class BankAccount {
    public static void main(String[] args) {
        ...
        double witdraw = key.nextDouble();//Dynamic

        //balance = balance-witdraw // regular way
        balance -=witdraw; // Shorthand operatir way

        //System.out.println("Your current balance : "+(balance-100));

        if(balance<0) {
            System.out.println("You took too much money. $100 overdraft fee will be applied");// balance = balance-100
            balance-=100;
