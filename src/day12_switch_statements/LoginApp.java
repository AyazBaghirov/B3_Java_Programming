...
import day10_if_statements.IfElseExample;
...
public class LoginApp {
    public static void main(String[] args) {
        ...
        System.out.println("Please, enter the last 4 digit of your SSN: ");
        ...
        if (userInputPin == actualPin && userInputSSN == actualSSN){
            ...
            if (actualPin!= userInputPin){ //incorrect pin-incorrect SSN
